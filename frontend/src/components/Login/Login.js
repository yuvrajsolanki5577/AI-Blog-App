...
import { loginUser } from '../../store/features/auth/authServices';
...
return (
    <>
      ...
      <h2 className="mb-6 text-4xl tracking-tight font-extrabold text-center text-gray-900 dark:text-white">Login</h2>
          ...
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form method='POST' onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
                  <div>
                      ...
                      <input type="email" name="email" id="email" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="name@company.com" value={values.email} onChange={handleChange} onBlur={handleBlur} required="" />
