...
const Categories = () => {
  return (
    ...
    <div className="flex flex-wrap -m-4">
        ...
        <Link to="/category/backend" className="block max-w-sm m-2 p-6 bg-white border border-gray-200 rounded-lg shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
        <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white"> Backend </h5>
        <p className="font-normal text-gray-700 dark:text-gray-400"> Backend Technologies Like Node JS </p>
        </Link>        
    </div>
    </div>
    </section>
