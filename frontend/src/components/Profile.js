          ...
          blogs.map((blog) => {
            return (
              <div className="m-2" key={blog._id}> 
                ...
                <span className="relative px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-opacity-0" onClick={() => Navigate(`/new-blog`)}>
                    Edit
                </span>
              </button>
